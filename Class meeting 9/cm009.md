...
##    label          x      y
##    <chr>      <dbl>  <dbl>
##  1 Sample A  0.0125  0.642
##  2 Sample A  1.13    2.41 
##  3 Sample A  0.391   1.54 
##  4 Sample A  0.355   0.218
##  5 Sample A -0.735  -1.49 
##  6 Sample A -1.81   -2.01 
##  7 Sample A -0.303  -0.258
##  8 Sample A  1.19   -1.44 
##  9 Sample A -3.08   -2.54 
## 10 Sample A -0.666  -1.94 
## # ... with 90 more rows
```
...
```
## Error in gaussian(mu = mu, sd = sd): unused arguments (mu = mu, sd = sd)
```
