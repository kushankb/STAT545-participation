...
1. Labels and units need to clear
1. visualization should be meaningful and make insightful
1. Should have proper scales- scales can be misleading
1. 
1.
...
- <<strong (One could see if thre )>>

- Main takeaway: Scale can be misleading. The population for each variable needs to be considered when comparing multiple variables in a bar graph. Where to start the axis make a difrerence on visualization too!
...
- Main takeaway: Starting and ending points matter! Use your existing knowledge to make a decision on where to start your axis.
...
<--- IMPORTANT RESOURCES: https://www.data-to-viz.com/#sankey    &    https://plot.ly/r/time-series/ --->
