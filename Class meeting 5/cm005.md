...
<img src="cm005_files/figure-html/unnamed-chunk-1-1.png" style="display: block; margin: auto;" />
...
| scale                 | 'linear' |
| statistical transform | 'FILL_THIS_IN'frequency |
...
ggplot(mauna, aes(y = month)) +
  geom_point(aes(conc,month))
```

<img src="cm005_files/figure-html/unnamed-chunk-4-1.png" style="display: block; margin: auto;" />
...
#Check!!!
p +
  geom_point(conc,month, colour = 'green')
```

```
## Error in layer(data = data, mapping = mapping, stat = stat, geom = GeomPoint, : object 'conc' not found
```
...
<img src="cm005_files/figure-html/unnamed-chunk-6-1.png" style="display: block; margin: auto;" />
...
```
## Error in eval(expr, envir, enclos): object 'geom_p' not found
```
...
<img src="cm005_files/figure-html/unnamed-chunk-8-1.png" style="display: block; margin: auto;" />
...
<img src="cm005_files/figure-html/unnamed-chunk-10-1.png" style="display: block; margin: auto;" />
...
<img src="cm005_files/figure-html/unnamed-chunk-11-1.png" style="display: block; margin: auto;" />
...
<img src="cm005_files/figure-html/unnamed-chunk-12-1.png" style="display: block; margin: auto;" />
