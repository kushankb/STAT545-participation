...
![](cm_008_files/figure-html/unnamed-chunk-2-1.png)<!-- -->
...
![](cm_008_files/figure-html/unnamed-chunk-3-1.png)<!-- -->
...
ggplot(gapminder, aes(gdpPercap, lifeExp)) +
  ...
  facet_wrap(~continent) #scales = "free_x", "free", "free_y" to have different scales of each plot
```

![](cm_008_files/figure-html/unnamed-chunk-4-1.png)<!-- -->
...
p<-gapminder %>% 
  ...
  ggplot(aes(gdpPercap, lifeExp, size=pop,fill= continent)) + #  color corresponds to the outline of the object where as fill corresponds to the inside of the object
  facet_wrap(~ continent, nrow=1) +
  geom_point(alpha = 0.4, shape=21) + #can add any shape object by using""
  scale_x_log10(labels = scales::comma_format())+
  scale_size_area()# to make the point density correspond to the pop density
p
```

![](cm_008_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
```r
ggplot(gapminder) +
  geom_point(aes(gdpPercap, lifeExp), size = 0.9) +
  scale_x_log10(labels = scales::dollar_format())
```

![](cm_008_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](cm_008_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](cm_008_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
![](cm_008_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
![](cm_008_files/figure-html/unnamed-chunk-10-1.png)<!-- -->
...
```r
hair %>%  ggplot(aes(Hair)) +
  geom_bar()+
  scale_y_continuous()
```

![](cm_008_files/figure-html/unnamed-chunk-12-1.png)<!-- -->
...
```r
ggplot(hair_eye, aes(Hair, Eye), shape = 15) +
  geom_point(aes(colour = n))
```

![](cm_008_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
